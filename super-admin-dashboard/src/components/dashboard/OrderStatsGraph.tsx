...
const OrderStatusGraph: React.FC = () => {
  ...
  const sampleData: OrderStatusData[] = [
    { name: "Completed", value: stats?.completed, color: "#1BAA7A" },
    { name: "In Process", value: stats?.inTransition, color: "#F59E0B" },
    { name: "Pending", value: stats?.pending, color: "#3B82F6" },
    { name: "Cancelled", value: stats?.cancelled, color: "#EF4444" },
  ]
  return (
    <div className="bg-[#171717] rounded-2xl border border-[#262626] p-6 shadow-sm w-full max-w-[498px] ">
      {/* HEADER */}
      <div className="mb-6">
        <h2 className="text-[18px] font-semibold text-white">Order Status</h2>
